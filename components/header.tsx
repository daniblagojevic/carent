                                ...
                                <div className="flex justify-between items-center gap-x-1">
                                    <Link href="/" className="" scroll={true}>
                                        <div className="flex items-center gap-x-2">
                                            <img src="/carent-logo-primary.png" className="h-6 object-contain" />
                                        </div>
                                    </Link>
                                        ...
                                        <div className="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
                                            <div className="grow">
                                                <div className="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-3">
                                                    ...
                                                    <a className="p-2 flex items-center rounded-lg text-black no-underline hover:text-majorelle-600" href="#">
                                                    ...
                                                    <Link className="p-2 flex items-center rounded-lg text-black no-underline hover:text-majorelle-600" href="/account">
                                                        <svg className="shrink-0 size-4 me-3 md:me-2 block md:hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path fill="#000000" d="M240 192C240 147.8 275.8 112 320 112C364.2 112 400 147.8 400 192C400 236.2 364.2 272 320 272C275.8 272 240 236.2 240 192zM448 192C448 121.3 390.7 64 320 64C249.3 64 192 121.3 192 192C192 262.7 249.3 320 320 320C390.7 320 448 262.7 448 192zM144 544C144 473.3 201.3 416 272 416L368 416C438.7 416 496 473.3 496 544L496 552C496 565.3 506.7 576 520 576C533.3 576 544 565.3 544 552L544 544C544 446.8 465.2 368 368 368L272 368C174.8 368 96 446.8 96 544L96 552C96 565.3 106.7 576 120 576C133.3 576 144 565.3 144 552L144 544z" /></svg>
                                                        Account
                                                    </Link>
                                                </div>
                                            </div>
